                 ...
                 (filters.period === 'month' && filters.compareWith === 'previous') ? (
                  ...
                  <LineChart data={detailData.evolutionData}>
                    ...
                    <Line 
                      ...
                      stroke="hsl(var(--primary))" 
                      strokeWidth={3}
                      name={filters.compareWith ? comparisonLabels.current : 'Effectif'}
                    ...
                    {filters.compareWith && (
                      <Line 
                        ...
                        strokeWidth={2}
                        strokeDasharray="5 5"
                        name={filters.compareWith === 'year-ago' ? `Année ${new Date().getFullYear() - 1}` : comparisonLabels.comparison}
                    ...
                    {filters.compareWith && (
                      <Bar 
                        ...
                        fill="hsl(var(--muted-foreground))" 
                         name={comparisonLabels.comparison}
                        radius={[4, 4, 0, 0]}
                      />
                    )}
                  </BarChart>
